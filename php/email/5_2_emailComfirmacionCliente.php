<?php
    ...
    function mailPedido($email, $numPedido){
        ...
        $mail->Username = "daw2.javier@gmail.com"; // Dirección de correo desde donde se envía.
        $mail->Password = "zcfw uuhz rsei gcbw"; // Contraseña generada por la verificación en dos pasos (Google App Password).
